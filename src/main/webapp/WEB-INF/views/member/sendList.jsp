...
<body>
	...
	<div class="page-content">
		<div class="page-title">보낸 쪽지</div>
		<table class="tbl tbl-hover msg-tbl">
			<tr>
				<th><input type="checkbox" id="allChk"></th><th>제목</th><th>수신자</th><th>받은 날짜</th>
			</tr>
			<%for(Msg l : list){ %>
			<tr class="tr-1">
				...
				<td>
				<ul class="navi">
					<li><a href="#"><%=l.getReceiver() %></a>
						<ul class="sub-navi">
							<li><a href="/writeMsgFrm.do?memberId=<%=l.getReceiver()%>">쪽지보내기</a></li>
						</ul>
					</li>
				</ul></td>
				<td><%=l.getReqDate() %></td>	
	...
	$(".deleteMsg").on("click",function(){
		...
		location.href="/deleteSend.do?delSend=y&msgNos="+msgNos.join("/");
	});
