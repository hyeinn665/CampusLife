				...
				<table class="tbl tbl-hover subject-tbl">
					...
					<%if(tt!=null) {%>
							...
							<tr class="tr-1">
								...
								<td>
									<a href="/insertCourse.do?memberNo=<%=m.getMemberNo() %>&subjectNo=<%=rs2.getSubjectNo()%>" id="btn">수강하기</a>
								</td>
							</tr>
						<%}%>
					<%}%>
			...
			<table class="tbl tbl-hover subject-tbl t2">
				...
				<%if(tt!=null) {%>
						...
						<tr class="tr-1">
							...
							<td>
								<a href="/insertCourse.do?memberNo=<%=m.getMemberNo() %>&subjectNo=<%=ss2.getSubjectNo()%>" id="btn">수강하기</a>								
							</td> 
						</tr>
					<%}%>
				<%}%>
