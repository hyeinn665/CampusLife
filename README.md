...
<br><br>
## 🗨️ 후기
- git을 모르는 팀원들이 있어서 git을 사용하지 못했다. 파일을 합치는데 오류가 너무 많았어서 다음 플젝 땐 git 사용법을 알려주면서 사용하자고 해야겠다.
- 비밀 댓글 기능을 구현할 때 어떤 사용자에게 댓글을 공개해야하는지 명확하게 정하지 않아 구현에서 헷갈렸다. 조금 더 체계적으로 정리해서 구현할 수 있도록 해야겠다.
